...
export default function HomePage() {
  return (
    <section className="relative w-full px-4 sm:px-6 lg:px-8 py-20">
      ...
      <div className="w-full max-w-3xl ml-auto text-right">

        {/* ========== About Section ========== */}
        <section id="about" className="mb-10">
          <h1 className="text-4xl sm:text-5xl font-bold leading-tight mb-4" style={{ color: "var(--fg)" }}>
            Hey, it&apos;s Matteo :)
          </h1>
        ...
        <section id="trips" className="mb-10">
